...
// Export Mode: process.env-static
 ...
 */
const comprehensiveTestWorkspaceSchema = {
  parse: (
...
/** 工作空间名称 */
export const SAFENV_WORKSPACE_NAME = /* @__PURE__ */ parseValue.parse(
  process.env.WORKSPACE_NAME
)

/** 工作空间版本号 */
export const SAFENV_WORKSPACE_VERSION = /* @__PURE__ */ parseValue.parse(
  process.env.WORKSPACE_VERSION
)

/** 运行环境 (development/production/test) */
export const SAFENV_NODE_ENV = /* @__PURE__ */ parseValue.parse(
  process.env.NODE_ENV
)

/** 服务器主机地址 */
export const SAFENV_SERVER_HOST = /* @__PURE__ */ parseValue.parse(
  process.env.SERVER_HOST
)

/** 服务器端口号 */
export const SAFENV_SERVER_PORT = /* @__PURE__ */ parseValue.parse(
  process.env.SERVER_PORT
)

/** 主数据库连接字符串 */
export const SAFENV_DATABASE_URL = /* @__PURE__ */ parseValue.parse(
  process.env.DATABASE_URL
)

/** 数据库连接池最小连接数 */
export const SAFENV_DATABASE_POOL_MIN = /* @__PURE__ */ parseValue.parse(
  process.env.DATABASE_POOL_MIN
)

/** 数据库连接池最大连接数 */
export const SAFENV_DATABASE_POOL_MAX = /* @__PURE__ */ parseValue.parse(
  process.env.DATABASE_POOL_MAX
)

/** Redis连接字符串 */
export const SAFENV_REDIS_URL = /* @__PURE__ */ parseValue.parse(
  process.env.REDIS_URL
)

/** 默认缓存过期时间（秒） */
export const SAFENV_CACHE_DEFAULT_TTL = /* @__PURE__ */ parseValue.parse(
  process.env.CACHE_DEFAULT_TTL
)

/** 外部API基础URL */
export const SAFENV_API_BASE_URL = /* @__PURE__ */ parseValue.parse(
  process.env.API_BASE_URL
)

/** 外部API密钥 */
export const SAFENV_API_KEY = /* @__PURE__ */ parseValue.parse(
  process.env.API_KEY
)

/** API请求超时时间（毫秒） */
export const SAFENV_API_TIMEOUT = /* @__PURE__ */ parseValue.parse(
  process.env.API_TIMEOUT
)

/** API请求重试次数 */
export const SAFENV_API_RETRY_COUNT = /* @__PURE__ */ parseValue.parse(
  process.env.API_RETRY_COUNT
)

/** JWT签名密钥 */
export const SAFENV_JWT_SECRET = /* @__PURE__ */ parseValue.parse(
  process.env.JWT_SECRET
)

/** JWT过期时间 */
export const SAFENV_JWT_EXPIRES_IN = /* @__PURE__ */ parseValue.parse(
  process.env.JWT_EXPIRES_IN
)

/** BCrypt加密轮数 */
export const SAFENV_BCRYPT_ROUNDS = /* @__PURE__ */ parseValue.parse(
  process.env.BCRYPT_ROUNDS
)

/** 是否启用日志记录 */
export const SAFENV_ENABLE_LOGGING = /* @__PURE__ */ parseValue.parse(
  process.env.ENABLE_LOGGING
)

/** 是否启用指标收集 */
export const SAFENV_ENABLE_METRICS = /* @__PURE__ */ parseValue.parse(
  process.env.ENABLE_METRICS
)

/** 是否启用链路追踪 */
export const SAFENV_ENABLE_TRACING = /* @__PURE__ */ parseValue.parse(
  process.env.ENABLE_TRACING
)

/** 是否启用调试模式 */
export const SAFENV_DEBUG_MODE = /* @__PURE__ */ parseValue.parse(
  process.env.DEBUG_MODE
)

/** 启用的功能标志列表 */
export const SAFENV_FEATURE_FLAGS = /* @__PURE__ */ parseValue.parse(
  process.env.FEATURE_FLAGS
)

/** 日志级别 (debug/info/warn/error) */
export const SAFENV_LOG_LEVEL = /* @__PURE__ */ parseValue.parse(
  process.env.LOG_LEVEL
)

/** 日志格式 (json/text) */
export const SAFENV_LOG_FORMAT = /* @__PURE__ */ parseValue.parse(
  process.env.LOG_FORMAT
)

/** 日志文件最大保留数量 */
export const SAFENV_LOG_MAX_FILES = /* @__PURE__ */ parseValue.parse(
  process.env.LOG_MAX_FILES
)

/** 监控指标端口 */
export const SAFENV_METRICS_PORT = /* @__PURE__ */ parseValue.parse(
  process.env.METRICS_PORT
)

/** 健康检查路径 */
export const SAFENV_HEALTH_CHECK_PATH = /* @__PURE__ */ parseValue.parse(
  process.env.HEALTH_CHECK_PATH
)

/** CORS允许的源列表 */
export const SAFENV_CORS_ORIGINS = /* @__PURE__ */ parseValue.parse(
  process.env.CORS_ORIGINS
)

/** CORS允许的HTTP方法 */
export const SAFENV_CORS_METHODS = /* @__PURE__ */ parseValue.parse(
  process.env.CORS_METHODS
)

/** 速率限制窗口时间（毫秒） */
export const SAFENV_RATE_LIMIT_WINDOW = /* @__PURE__ */ parseValue.parse(
  process.env.RATE_LIMIT_WINDOW
)

/** 速率限制最大请求数 */
export const SAFENV_RATE_LIMIT_MAX = /* @__PURE__ */ parseValue.parse(
  process.env.RATE_LIMIT_MAX
)

/** 文件上传最大大小（字节）50MB */
export const SAFENV_UPLOAD_MAX_SIZE = /* @__PURE__ */ parseValue.parse(
  process.env.UPLOAD_MAX_SIZE
)

/** 允许上传的文件类型 */
export const SAFENV_UPLOAD_ALLOWED_TYPES = /* @__PURE__ */ parseValue.parse(
  process.env.UPLOAD_ALLOWED_TYPES
)

/** SMTP服务器地址 */
export const SAFENV_SMTP_HOST = /* @__PURE__ */ parseValue.parse(
  process.env.SMTP_HOST
)

/** SMTP服务器端口 */
export const SAFENV_SMTP_PORT = /* @__PURE__ */ parseValue.parse(
  process.env.SMTP_PORT
)

/** SMTP用户名 */
export const SAFENV_SMTP_USER = /* @__PURE__ */ parseValue.parse(
  process.env.SMTP_USER
)

/** SMTP密码 */
export const SAFENV_SMTP_PASS = /* @__PURE__ */ parseValue.parse(
  process.env.SMTP_PASS
)

/** AWS区域 */
export const SAFENV_AWS_REGION = /* @__PURE__ */ parseValue.parse(
  process.env.AWS_REGION
)

/** AWS访问密钥ID */
export const SAFENV_AWS_ACCESS_KEY_ID = /* @__PURE__ */ parseValue.parse(
  process.env.AWS_ACCESS_KEY_ID
)

/** AWS私有访问密钥 */
export const SAFENV_AWS_SECRET_ACCESS_KEY = /* @__PURE__ */ parseValue.parse(
  process.env.AWS_SECRET_ACCESS_KEY
)

/** S3存储桶名称 */
export const SAFENV_S3_BUCKET_NAME = /* @__PURE__ */ parseValue.parse(
  process.env.S3_BUCKET_NAME
)

/** 应用全局配置对象 */
export const SAFENV_APP_CONFIG = /* @__PURE__ */ parseValue.parse(
  process.env.APP_CONFIG
)

/** 实验性功能开关 */
export const SAFENV_EXPERIMENTAL_FEATURES = /* @__PURE__ */ parseValue.parse(
