import { BasePlugin } from "./base-oh72DzY-.mjs";
import { GenFilePlugin } from "./genFile-BsNqFjb-.mjs";
import { GenTsPlugin } from "./genTs-J9a1TLxc.mjs";
...
var SafenvCore = class {
	...
	async loadPlugin(pluginConfig) {
		const { GenFilePlugin: GenFilePlugin$1 } = await import("./genFile-DPRs03tK.mjs");
		const { GenTsPlugin: GenTsPlugin$1 } = await import("./genTs-CFCEKsRG.mjs");
		const pluginMap = {
...
//#endregion
export { BasePlugin, FileImportExportAdapter, GenFilePlugin, GenTsPlugin, HttpImportExportAdapter, SafenvBuilder, SafenvCore, SafenvServer, SafenvWorkspace, createBuilder, createSafenv, createServer, createWorkspace };
