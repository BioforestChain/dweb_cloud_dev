import { BasePlugin, __require } from "./base-oh72DzY-.mjs";
import { resolve } from "node:path";
import { createServer } from "node:http";

//#region src/plugins/genFile.ts
var GenFilePlugin = class extends BasePlugin {
	name = "genFilePlugin";
	server;
	constructor(options) {
		super();
	...
	generateTomlFile(variables) {
		const TOML = __require("@iarna/toml");
...
//#endregion
export { GenFilePlugin };
//# sourceMappingURL=genFile-BsNqFjb-.mjs.map